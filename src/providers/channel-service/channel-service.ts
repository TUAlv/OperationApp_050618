...
export class ChannelService {
    ...
    constructor(
        ...
        //this.channelConfig.url = "http://localhost:8499/signalr";
        //this.channelConfig.hubName = "PushNotificationsToMobile";
        console.log("chanelconfigurl:" + this.channelConfig.url);
        console.log("chanelconfighubName:" + this.channelConfig.hubName);
        ...
        this.hubProxy.on('UpdateNotificationToMobile', (latestMsg) => this.UpdateNotificationToMobile(latestMsg));
    ...
    sendLocalNotification(message: string){

        // console.log('Platform cordova: ' +this.plt.is('cordova'));
        // console.log('Platform windows: ' +this.plt.is('windows'));
        // console.log('Platform ios: ' +this.plt.is('ios'));
        // console.log('Platform android: ' +this.plt.is('android'));
        ...
        if(this.plt.is('android')){        
                ...
                this.localNotifications.cancelAll().then(() => {
                    ...
                    this.localNotifications.schedule({
                        title:"EJEMPLO PUSH NOTIFICATION",
                        text: message
                    });                                               
                });
    ...
    // Método empleado para mostrar la notificación proveniente de signalr
    UpdateNotificationToMobile(latestMsg: string) {               
        this.sendLocalNotification(latestMsg);        
    }
}